...
const LetterPairSwitch: React.FC = () => {
    ...
    return (
        <div className="relative h-56 flex justify-center flex-row text-7xl sm:text-8xl text-et-light-gray font-bold mt-8 border-2 border-et-light-gray rounded-md hover:cursor-pointer">
