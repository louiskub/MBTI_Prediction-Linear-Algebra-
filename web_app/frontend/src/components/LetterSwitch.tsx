...
const LetterPairSwitch: React.FC = () => {
    ...
    return (
        <div className="relative h-56 flex justify-center flex-row text-7xl sm:text-8xl text-et-light-skin font-bold mt-8 bg-white  rounded-md hover:cursor-pointer transition-transform transform hover:scale-105">
